...
from email_validator import validate_email as ev, EmailNotValidError #email validator
import re
import bleach
...
class CreateMessageForm(FlaskForm):
    ...
    message = TextAreaField('Message', [
        validators.DataRequired(),
        validators.Length(max=5000, message="Message cannot exceed 5000 characters.")
    ])
